...
class CheckboxFilter(FilterBase):
    ...
    def equals(self, property_: str, value: bool):
        ...
        return CheckboxFilter(_return_value(property_, self._filter_name, method_name, value))
...
class DateFilter(FilterBase):
    ...
    def after(self, property_: str, value: str):
        ...
        return DateFilter(_return_value(property_, self._filter_name, method_name, value))
    ...
    def is_empty(self, property_: str):
        ...
        method_name = sys._getframe(0).f_code.co_name
        return DateFilter(_return_value(property_, self._filter_name, method_name, True))
    ...
    def next_month(self, property_: str):
        ...
        method_name = sys._getframe(0).f_code.co_name
        return DateFilter(_return_value(property_, self._filter_name, method_name, {}))
...
class FilesFilter(FilterBase):
    ...
    def is_empty(self, property_: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return FilesFilter(_return_value(property_, self._filter_name, method_name, True))
...
class FormulaFilter(FilterBase):
    ...
    def checkbox(self, property_: str, value: CheckboxFilter):
        ...
        return FormulaFilter(_return_value(property_, self._filter_name, method_name, _value))
...
class MultiSelectFilter(FilterBase):
    ...
    def contains(self, property_: str, value: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return MultiSelectFilter(_return_value(property_, self._filter_name, method_name, value))
    ...
    def is_empty(self, property_: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return MultiSelectFilter(_return_value(property_, self._filter_name, method_name, True))
...
class NumberFilter(FilterBase):
    ...
    def does_not_equal(self, property_: str, value: float):
        ...
        method_name = sys._getframe().f_code.co_name
        return NumberFilter(_return_value(property_, self._filter_name, method_name, value))
    ...
    def is_empty(self, property_: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return NumberFilter(_return_value(property_, self._filter_name, method_name, True))
...
class PeopleFilter(FilterBase):
    ...
    def contains(self, property_: str, value: str): # UUIDv4 ex) "6c574cee-ca68-41c8-86e0-1b9e992689fb"
        ...
        method_name = sys._getframe().f_code.co_name
        return PeopleFilter(_return_value(property_, self._filter_name, method_name, value))
    ...
    def is_empty(self, property_: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return PeopleFilter(_return_value(property_, self._filter_name, method_name, True))
...
class RelationFilter(FilterBase):
    ...
    def contains(self, property_: str, value: str): # UUIDv4 ex) "6c574cee-ca68-41c8-86e0-1b9e992689fb"
        ...
        method_name = sys._getframe().f_code.co_name
        return RelationFilter(_return_value(property_, self._filter_name, method_name, value)) # UUIDv4 ex) "6c574cee-ca68-41c8-86e0-1b9e992689fb"
    ...
    def does_not_contain(self, property_: str, value: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return RelationFilter(_return_value(property_, self._filter_name, method_name, value))
    ...
    def is_empty(self, property_: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return RelationFilter(_return_value(property_, self._filter_name, method_name, True))
...
class RichTextFilter(FilterBase):
    ...
    def contains(self, property_: str, value: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return RichTextFilter(_return_value(property_, self._filter_name, method_name, value))
    ...
    def is_empty(self, property_: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return RichTextFilter(_return_value(property_, self._filter_name, method_name, True))
...
class SelectFilter(FilterBase):
    ...
    def equals(self, property_: str, value: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return SelectFilter(_return_value(property_, self._filter_name, method_name, value))
    ...
    def is_empty(self, property_: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return SelectFilter(_return_value(property_, self._filter_name, method_name, True))
...
class StatusFilter(FilterBase):
    ...
    def equals(self, property_: str, value: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return StatusFilter(_return_value(property_, self._filter_name, method_name, value))
    ...
    def is_empty(self, property_: str):
        ...
        method_name = sys._getframe().f_code.co_name
        return StatusFilter(_return_value(property_, self._filter_name, method_name, True))
...
class IDFilter(FilterBase):
    ...
    def does_not_equal(self, property_: str, value: float):
        ...
        method_name = sys._getframe().f_code.co_name
        return IDFilter(_return_value(property_, self._filter_name, method_name, value))
...
class RichText2Filter(FilterBase):
    _filter_name = "rich_text"
